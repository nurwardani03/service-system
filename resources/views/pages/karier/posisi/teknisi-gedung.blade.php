  ...
  <div class="max-w-4xl mx-auto px-6">
    ...
    <div class="bg-[#e5e5e5] rounded-lg p-8">
      ...
      <p class="text-gray-700 leading-relaxed text-base mb-8">
        ...
        Teknisi Pemeliharaan Gedung<br>
        Bergabunglah bersama tim teknis Mega Sejahtera Perkasa untuk memastikan
        fasilitas klien tetap berfungsi dengan baik, aman, dan sesuai standar
        operasional gedung.
      </p>
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-2 gap-y-2 text-sm text-gray-700">
          <div>Posisi</div><div>: Teknisi Pemeliharaan Gedung</div>
          <div>Lokasi</div><div>: Jakarta Pusat</div>
          <div>Jadwal</div><div>: Shift / Rotasi</div>
          <div>Jam Kerja</div><div>: 8 jam per shift</div>
      ...
      {{-- KEUNTUNGAN --}}
      <div class="mb-8">
        <div class="section-title">⭐ Mengapa Anda Harus Bergabung</div>
        <ul class="checklist text-sm text-gray-700">
          ...
          <li>
            ...
            Lingkungan kerja profesional & sistem BAS
          </li>
          <li>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M5 13l4 4L19 7"/>
            </svg>
            Pelatihan teknis lanjutan tersedia
          </li>
        </ul>
      </div>
      ...
      <div class="mb-8">
        ...
        <ul class="checklist text-sm text-gray-700">
          <li>
            ...
            Pemeliharaan rutin listrik, plumbing & HVAC dasar
          </li>
          <li>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M5 13l4 4L19 7"/>
            </svg>
            Menangani perbaikan ringan & preventif
          </li>
          <li>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M5 13l4 4L19 7"/>
            </svg>
            Melakukan inspeksi fasilitas secara berkala
          </li>
        </ul>
      </div>
      ...
      <div class="mb-10">
        ...
        <ul class="checklist text-sm text-gray-700">
          <li>
            ...
            Pengalaman minimal 1 tahun di maintenance
          </li>
          <li>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M5 13l4 4L19 7"/>
            </svg>
            Mampu membaca alat ukur & peralatan teknis
          </li>
          <li>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M5 13l4 4L19 7"/>
            </svg>
            Sertifikasi teknis menjadi nilai tambah
          </li>
        </ul>
      </div>
